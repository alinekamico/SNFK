    ...
    <div className="min-h-screen flex items-center justify-center bg-kami-charcoal">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-kami-cream/60 mt-2 text-sm font-body tracking-wider uppercase">
        ...
        <div className="bg-kami-cream rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-kami-charcoal mb-1">E-mail</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm font-medium text-kami-charcoal mb-1">Senha</label>
              <input
                type="password"
                value={senha}
                ...
                className="w-full border border-kami-charcoal/30 rounded-lg px-4 py-2.5 bg-white text-kami-charcoal focus:outline-none focus:ring-2 focus:ring-kami-red font-body text-sm"
              />
            </div>

            {erro && (
              <p className="text-kami-red text-sm font-body">{erro}</p>
            )}
